...
// The Chinese topics this viewer currently supports. "lin-zexu" (學習林則徐) is
// excluded on purpose: the unit is not released, so its records stay hidden.
const CHINESE_TOPICS = ["scenery-description", "character-description"];
